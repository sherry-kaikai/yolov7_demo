...
from yolov7_opencv_3output import YOLOV7_Detector
...
class YoloTest(object):
    def __init__(self, json_path, image_dir, save_json_path):
        ...
        self.yolov7 = YOLOV7_Detector(bmodel_path="../data/models/BM1684/yolov7_640_v0.1_3output_fp32_1b.bmodel",
                                      tpu_id = 0,
                                      class_names_path="../data/images/coco.names",
                                      confThreshold=0.001,
                                      nmsThreshold=0.65,
                                      objThreshold=0.001)
        print('yolov7 is loaded.')
    ...
    def evaluate(self):
        ...
        for i, (k, obj) in enumerate(tqdm(self.cocoGt.imgs.items())):
            ...
            dets = self.yolov7.do_once_proc(file_path)
