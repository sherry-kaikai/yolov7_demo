...
class YoloV7 {
  ...
  int post_process(const std::vector<bm_image>& images, std::vector<YoloV7BoxVec>& boxes);
  ...
  int batch_size();
  int Detect(const std::vector<bm_image>& images, std::vector<YoloV7BoxVec>& boxes);
